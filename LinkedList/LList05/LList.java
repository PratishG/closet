/*****************************************************
 * class LList -- skeleton
 * Implements a linked list of LLNodes.
 * Version 05 is iterable
 *****************************************************/
...
public class LList<T> implements List<T> { //your List.java must be in same dir
	...
	public T next() {
	    /*** YOUR IMPLEMENTATION HERE ***/
	    //Q: Where in here do you issue the command below?
	    // throw new NoSuchElementException();
	}

	public void remove() {
	    /*** YOUR IMPLEMENTATION HERE ***/
	    //Q: Under what circumstances do you issue the command below?
	    //throw new IllegalStateException("must call next() beforehand");

	    //Q: What are the 4 distinct cases to consider?
	}

    }//end class MyIterator
    // ************* end MyIterator class def ****************
    // *******************************************************
